...
int
parse_options (uint8_t * buf, size_t buflen, uint8_t codeval)
{
  uint8_t *opt /* , *optval */ ;
  size_t offset, left;
...
/* Parse exactly one option */
/* Returns the length of the option header */
/* That is the value to add to the current data pointer to point to the Option Value */
/* or -1 if an inconsistency is detected */

int
option_parse (uint8_t * opt, size_t _left,
